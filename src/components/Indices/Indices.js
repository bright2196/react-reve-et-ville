    ...
    return (
      <div className={parentClassName}>
        ...
        <div className={styles.indiceContainer}>
            ...
            {this.props.page === 6 && (<p>Eclairez les parties du tableau pour voir s' il n’y a pas une inscription à récupérer. Il y a peu de supports sur lesquels il pourrait y avoir des inscriptions… Cela devrait vous mettre sur la voie.</p>)}
            {this.props.page === 7 && (<p>On y voit rien! Si seulement il n’y avait pas toute cette poussière…</p>)}
