    ...
    return (
      <div className={parentClassName}>
        ...
        <div className={styles.indiceContainer}>
            {this.props.page === 1 && (<p>En observant bien, la carte est divisée en plusieurs cases, comme un damier... cliquez sur la zone ou se situe le musée. Echec et mat...</p>)}
            ...
            {this.props.page === 6 && (<p>Éclairez les parties du tableau pour voir s' il n’y a pas une inscription à récupérer. Cela devrait vous mettre sur la voie.</p>)}
